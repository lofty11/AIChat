...
public class ExtensionInput extends SSObject implements Serializable {
    ...
    public ExtensionInput(Long id, Long creatorId, Long modifierId, String modifierName, String creatorName, LocalDateTime gmtCreate, LocalDateTime gmtModified,
                          String fieldName, String field, Integer type, String enumerationRange, Integer required, String description, Long applicationId){
