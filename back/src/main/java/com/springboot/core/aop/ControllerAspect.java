...
import static com.springboot.core.model.Constants.BEGIN_TIME;
import static com.springboot.core.model.Constants.END_TIME;
...
public class ControllerAspect {
    ...
    @Value("${core.page-size.max}")
    private int max_page_size;

    @Value("${core.page-size.default}")
     ...
     * @throws Throwable
     */
    @Around("com.springboot.core.aop.CommonPointCuts.controllers()")
